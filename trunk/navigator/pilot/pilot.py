...
class Pilot():
    ...
    def __init__(self, interface, opt):
        ...
        self.Vel = 0.12 #0.03
        self.startCount = 0
        self.K1 = 0.15 #yaw adjustment gain rate
    ...
    def update(self):
        #pose3d = self.interface.getsimPose3D()
    ...
    def pilot(self, pose3d):
       ...
       # print (yawcontrol)
        ...
        self.interface.sendCMDVel(xVel, 0.0, zVel*1.2, yawcontrol)
